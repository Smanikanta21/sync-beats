...
export default function LoginPage(props: PropData) {
                ...
                <div className="bg-white/20 backdrop-blur-lg p-8 rounded-lg shadow-lg w-full max-w-md">
                    ...
                    <form>
                        ...
                        <div className="mb-6">
                            ...
                            <button className="absolute right-12 top-55 bottom-50" onClick={(e)=>{setShowPassword(!showPassword)}}>{showPassword ? <Eye/> : <EyeClosed/>}</button>
                        </div>
